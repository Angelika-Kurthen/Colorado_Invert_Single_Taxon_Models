############################
# Temperature % increase x HFE CHIR
#############################
...
# assign index(for easy calling later)
flows$Index <- seq(1:length(flows$Discharge))
...
rm(temp)
rm(temps)
rm(CHIR_temp_abund_HFE)
rm(CHIR_temp_biomass_HFE)
